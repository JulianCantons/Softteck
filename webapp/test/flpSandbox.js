		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comsoftteckproyectoempresa-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsoftteckproyectoempresa-display": {
								"semanticObject": "comsoftteckproyectoempresa",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.softteck.proyectoempresa",
									"url": sap.ui.require.toUrl("com/softteck/proyectoempresa")
								}
							}
						}
					}
